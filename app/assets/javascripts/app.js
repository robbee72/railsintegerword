...
function NumToWord(inputNumber, outputEntrance) {
	...
	const ones = ['Zero', ' One', ' Two', ' Three', ' Four', ' Five', ' Six', ' Seven', ' Eight', ' Nine'] // words for 0-9
	const twos = [
		'Ten',
		' Eleven',
		' Twelve',
	...
	const tens = ['', 'Ten', ' Twenty', ' Thirty', ' Forty', ' Fifty', ' Sixty', ' Seventy', ' Eighty', ' Ninety'] //words for 'tys
